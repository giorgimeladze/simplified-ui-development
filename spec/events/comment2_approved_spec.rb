...
RSpec.describe Comment2Approved do
  describe 'inheritance' do
    it 'inherits from BaseEvent' do
      expect(Comment2Approved.superclass).to eq(BaseEvent)
    end
  end

  describe 'instantiation' do
    it 'can be instantiated' do
      expect { Comment2Approved.new }.not_to raise_error
    end

    it 'can be instantiated with data' do
      event = Comment2Approved.new(data: { comment_id: '123' })
