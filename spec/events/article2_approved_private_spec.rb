...
RSpec.describe Article2ApprovedPrivate do
  describe 'inheritance' do
    it 'inherits from BaseEvent' do
      expect(Article2ApprovedPrivate.superclass).to eq(BaseEvent)
    end
  end

  describe 'instantiation' do
    it 'can be instantiated' do
      expect { Article2ApprovedPrivate.new }.not_to raise_error
    end

    it 'can be instantiated with data' do
      event = Article2ApprovedPrivate.new(data: { article_id: '123' })
