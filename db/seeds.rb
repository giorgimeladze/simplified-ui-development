...
Article.create([
                 ...
                 { title: 'Third Article', content: 'Content of the third article.', user_id: user.id,
                   status: 'published' },
                 { title: 'Fourth Article', content: 'Content of the fourth article.', user_id: user.id,
                   status: 'privated' },
                 { title: 'Fifth Article', content: 'Content of the fifth article.', user_id: user.id,
                   status: 'archived' }
               ])
